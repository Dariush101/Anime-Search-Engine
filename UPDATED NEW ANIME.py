...
anime_objects = [
    ...
    AnimeToGenre("Pokémon", 17, 2, 1,1,2,20,0),
    AnimeToGenre("Yu-Gi-Oh", 17, 2, 1,20,1,2,0),
    AnimeToGenre("Beyblade", 17, 2, 1,20,1,13,0),
    AnimeToGenre("Solo Leveling")
    AnimeToGenre("Tower God")
    AnimeToGenre("Ouran Host Club")
    AnimeToGenre("DAN DA DAN")
    AnimeToGenre("Mashle")
    AnimeToGenre("A Certain Magical Club")
    AnimeToGenre("Absolute Duo")
    AnimeToGenre("Afro Samurai")
    AnimeToGenre("Another")
    AnimeToGenre("Black Lagoon")
    AnimeToGenre("Deadman Wonderland")
    AnimeToGenre("Digimon")
    AnimeToGenre("Don't Toy With Me, Miss Nagatoro")
    AnimeToGenre("Edends Zero")
    AnimeToGenre("Fist Of the Northstar")
    AnimeToGenre ("Fullmetal Alchemist")
    AnimeToGenre("Fuuka")
    AnimeToGenre("Gintama")
    AnimeToGenre("Girlfriend, Girlfriend")
    AnimeToGenre("Goblin Slayer")
    AnimeToGenre("Haikyu")
    AnimeToGenre("Hell's Paradise")
    AnimeToGenre("Hellsing")
    AnimeToGenre("How Not to Summon a Demon Lord")
    AnimeToGenre("Masamune-kun's Revenge")
    AnimeToGenre("Megalobox")
    AnimeToGenre("My First Girlfriend is a Gal")
    AnimeToGenre("Omamori Himari")
    AnimeToGenre("OniAi")
    AnimeToGenre("ORESUKI")
    AnimeToGenre("Parasyte")
    AnimeToGenre("Plunderer")
    AnimeToGenre("Re:Zero")
    AnimeToGenre("Rent-a-Girlfriend")
    AnimeToGenre("Rurouni Kenshin")
    AnimeToGenre("Shimoneta")
    AnimeToGenre("Shuffle")
    AnimeToGenre("Skeleton Knight in Another World")
    AnimeToGenre("Snow White With the Red Hair")
    AnimeToGenre("Soul Eater")
    AnimeToGenre("Strike the Blood")
    AnimeToGenre("The Cafe Terrace and Its Goddesses")
    AnimeToGenre("The Detective is Already Dead")
    AnimeToGenre("The Devil is a Part-Timer")
    AnimeToGenre("The Future Diary")
    AnimeToGenre("The God of High School")
    AnimeToGenre("The Kingdoms of Ruin")
    AnimeToGenre("Tokyo Ravens")
    AnimeToGenre("Tokyo Revengers")
    AnimeToGenre("Tomo-chan Is a Girl")
    AnimeToGenre("Tsugumomo")
    AnimeToGenre("Tsukimichi, Moonlit Fantasy")
    AnimeToGenre("Twin Star Exorcists")
    AnimeToGenre("Vinland Saga")
    AnimeToGenre("Walkure Romanze")
    AnimeToGenre("Welcome to Demon School Iruma-kun")
    AnimeToGenre("When Supernatural Battles Became Commonplace")
    AnimeToGenre("World's End Harem")
    AnimeToGenre("Yu Yu Hakusho")
    AnimeToGenre("Zom 100: Bucket List of the Dead")
    AnimeToGenre("You are Ms. Servant")
    AnimeToGenre("Trinity Seven")
    AnimeToGenre("Trapped in a Data Sim")
    AnimeToGenre("To the Abandoned Sacred Beasts")
    AnimeToGenre("The Testament of Sister New Devil")
    AnimeToGenre("The Rising of the Shield Hero")
